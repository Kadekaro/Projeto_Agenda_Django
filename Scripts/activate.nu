...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kadek\Downloads\Projeto Agenda Django'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kadek\Downloads\Projeto Agenda Django\Scripts\deactivate.nu'
